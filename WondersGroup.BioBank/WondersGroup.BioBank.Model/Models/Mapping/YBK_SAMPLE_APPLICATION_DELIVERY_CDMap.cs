...
{
    public class YBK_SAMPLE_APPLICATION_DELIVERY_CDMap : EntityTypeConfiguration<YBK_SAMPLE_APPLICATION_DELIVERY_CD>
    {
        public YBK_SAMPLE_APPLICATION_DELIVERY_CDMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("YBK_SAMPLE_APPLICATION_DELIVERY_CD");
