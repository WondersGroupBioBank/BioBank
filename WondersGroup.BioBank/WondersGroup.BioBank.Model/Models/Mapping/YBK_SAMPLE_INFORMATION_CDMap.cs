...
{
    public class YBK_SAMPLE_INFORMATION_CDMap : EntityTypeConfiguration<YBK_SAMPLE_INFORMATION_CD>
    {
        public YBK_SAMPLE_INFORMATION_CDMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("YBK_SAMPLE_INFORMATION_CD");
